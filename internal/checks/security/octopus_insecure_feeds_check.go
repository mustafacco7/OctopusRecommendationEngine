...
func NewOctopusInsecureFeedsCheck(client *client.Client, errorHandler checks.OctopusClientErrorHandler) OctopusInsecureFeedsCheck {
	return OctopusInsecureFeedsCheck{client: client, errorHandler: errorHandler}
}
